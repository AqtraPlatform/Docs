...
## Informações gerais
“Multiselect” é um componente de UI projetado para exibir e configurar listas de referência de múltipla seleção. Funciona apenas com o tipo de campo Array.
...
|  | Vínculo | Multiselect de Catálogo | Contém um campo “Array” relacionado do modelo |
...
## Exceções
- **Funcionalidade Limitada**: Apenas adequado para dados do tipo “Array”.